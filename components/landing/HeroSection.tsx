...
<h1 className="mx-auto flex max-w-4xl flex-col gap-2 text-center font-productsFont text-[clamp(1.2rem,4.5vw,6rem)] font-normal leading-tight tracking-[-0.03em] text-white drop-shadow-[0_10px_38px_rgba(0,0,0,0.62)]">
  <div>
